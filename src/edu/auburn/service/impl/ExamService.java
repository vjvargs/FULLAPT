...
public class ExamService implements IExamService {
	...
	@Override
	public boolean updateDueDateAndTypeByEid(long date, int type, int eid, int keyboard, String name, String desc) {
		// TODO Auto-generated method stub
		return dao.updateDueDateAndTypeByEid(date, type, eid, keyboard, name, desc);
	}

	@Override
	public int getLastEid() {
		// TODO Auto-generated method stub
		return dao.getLastEid();
	}
