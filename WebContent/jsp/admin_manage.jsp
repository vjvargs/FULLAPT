	...
	<nav class="navbar navbar-inverse">
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				      <a class="navbar-brand" href="${pageContext.request.contextPath }/admin">ALT</a>    
			</div>
	...
	<div class="container w3-center">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				 ...
				 <a href="${pageContext.request.contextPath }/admin?method=usermanage"
					class="w3-btn btn-sq w3-pink w3-circle w3-xxxlarge w3-ripple">
					<br> <br> <span class="glyphicon glyphicon-user"></span><br />

					Manage Users <br>
				</a> 
				<a href="${pageContext.request.contextPath }/admin?method=managesemester"
