...
<body>
 ...
 <li>
	...
	<div class="container">
		...
		<a href="${pageContext.request.contextPath }/admin?method=all" ><u>All</u></a>
		<a href="${pageContext.request.contextPath }/admin?method=teachers" ><u>Teachers</u></a>
		<a href="${pageContext.request.contextPath }/admin?method=students" ><u>Students</u></a>
		<a href="${pageContext.request.contextPath }/admin?method=non" ><u>Non</u></a>
