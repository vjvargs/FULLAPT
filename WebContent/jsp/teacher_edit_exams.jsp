...
<body>
 ...
 <li>
	...
	<h1>Desc:<%out.print(e.getEdesc()); %></h1>
	<hr>
		<div class="wells">
			<form class="form-horizontal" action="${pageContext.request.contextPath }/teacher?method=updateexam&lid=<%out.print(l.getLid()); %>&eid=<%out.print(e.getEid()); %>"
				...
				<div class="form-group">
					<label class="control-label col-sm-3" for="lessonName">Exam
						Name:</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="control-label col-sm-3" for="lessonDescription">Exam
						Description:</label>
					<div class="col-sm-9">
						<input type="text" class="form-control"
							id="lessonDescription" placeholder="Enter Exam Desciprtion"
							name="edesc">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-3" for="level">Choose type</label>
					<div class="col-sm-9">
						<select name="isprac">
				...
				<div class="form-group">
					<label class="control-label col-sm-3" for="level">Choose the keyboard:</label>
					<div class="col-sm-9">
						<select name="etype">
				...
				<!-- <div class="form-group">
				 ...
				 -->
					<label class="control-label col-sm-3" for="dueDate">Due
						Date:</label>
					<div class="col-sm-4">
